...
# Multi Deck Filter Constants
DECK_FILTER_COUNT_DEFAULT = 1
DECK_FILTER_COUNT_MIN = 1
DECK_FILTER_COUNT_MAX = 6
DECK_FILTER_COUNT_OPTIONS = [str(i) for i in range(DECK_FILTER_COUNT_MIN, DECK_FILTER_COUNT_MAX + 1)]
DECK_FILTER_NONE = "None"
DECK_FILTERS_WITH_NONE = [DECK_FILTER_NONE] + DECK_FILTERS

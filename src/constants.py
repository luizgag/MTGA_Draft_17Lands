...
FIELD_LABEL_BEST_GPWR = "Best GPWR"
FIELD_LABEL_BEST_GIHWR = "Best GIHWR"

DATA_SET_VERSION_3 = 3.0

WIN_RATE_OPTIONS = [DATA_FIELD_GIHWR, DATA_FIELD_OHWR,
                    DATA_FIELD_GPWR, DATA_FIELD_GNSWR, DATA_FIELD_GDWR]
FORCED_RATING_WIN_RATE_FIELDS = frozenset({DATA_FIELD_GIHWR, DATA_FIELD_GPWR, DATA_FIELD_OHWR, DATA_FIELD_GDWR})
...
CARD_RATINGS_INTER_SOURCE_DELAY_SECONDS = 5
CARD_RATINGS_ATTEMPT_MAX = 5
SEVENTEENLANDS_REQUEST_HEADERS = {"User-Agent": "MTGA_Draft_17Lands/1.0", "Accept": "application/json"}

SCRYFALL_REQUEST_BACKOFF_DELAY_SECONDS = 5
SCRYFALL_REQUEST_ATTEMPT_MAX = 5
SCRYFALL_REQUEST_HEADERS = {"User-Agent": "MTGA_Draft_17Lands/1.0", "Accept": "application/json"}
...
# Fields that represent game counts — summed during dataset merge (not averaged)
COUNT_FIELDS = {DATA_FIELD_NGP, DATA_FIELD_NGOH, DATA_FIELD_GIH, DATA_FIELD_NGND, DATA_FIELD_NGD}
...
COLUMNS_OPTIONS_EXTRA_DICT = {
    ...
    FIELD_LABEL_WHEEL: DATA_FIELD_WHEEL,
    FIELD_LABEL_COLORS: DATA_FIELD_COLORS,
    FIELD_LABEL_BEST_GPWR: DATA_FIELD_BEST_GPWR,
    FIELD_LABEL_BEST_GIHWR: DATA_FIELD_BEST_GIHWR,
}
...
MIN_TABLE_WIDTH = 200  # Minimum unscaled table width in pixels
